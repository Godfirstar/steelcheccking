...
onMounted(() => {
  gsap.to(teamLogo.value, { y: 100, opacity: 1, duration: 1, ease: 'power2.inOut' })
  gsap.to(tn.value, { y: 100, opacity: 1, duration: 0.3, ease: 'ease.inOut' })
})
...
<template>
  ...
  <pictureContainer :change="enter" id="picture1" ref="container1"> </pictureContainer>

  <pictureContainer id="picture2" ref="container2"> </pictureContainer>
  <pictureContainer id="picture3" ref="container3"> </pictureContainer>
  ...
  <div
    ...
    @mouseenter="
      (container1?.rrrotate(),
      container2?.bigger(),
      container3?.rrrotateback2(),
      container4?.bigger())
    "
    @mouseleave="
      (container1?.rrrotateback(),
      container2?.smaller(),
      container3.rrrotate(),
      container4?.smaller())
    "
  ...
  <div ref="ts" class="ts">
    ...
    <introduction
      ref="i1"
      id="i1"
      introduction="在本项⽬中，我们设计了⼀个基于机器视觉的钢铁表面检测平台，旨在应对工业质检场景中复杂多样的缺陷。
  ...
  <div ref="pg4" class="pg4" id="pg4">
    <div class="carousel-container">
      ...
      <div class="carousel-wrapper">
        <button class="arrow left-arrow" @click="scroll(-1)">❮</button>

        <div class="carousel-track" ref="track" @scroll.passive="handleScroll1">
          <div
        ...
        <button class="arrow right-arrow" @click="scroll(1)">❯</button>
      </div>
  ...
  <div class="kuai1" ref="kuai1">
    <span class="w">在本项⽬中，我们设计了⼀个</span
    >基于机器视觉的钢铁表面检测平台，旨在应对工业质检场景中复杂多样的缺陷。我们的系统经过精⼼设计，不仅能够有效识别出缺陷的类型，如
...
.sm {
  ...
  align-items: center;
  box-shadow:
    inset 0 0 5px 10px rgba(0, 0, 0, 0.5),
